                        ...
                        <div className="flex flex-wrap items-center justify-center">
                            ...
                            <div className="flex flex-col items-center justify-center w-28 px-4 pb-6">
                                ...
                                >
                                    <path
                                        fill="#9F9FED"
                                        d="M-55.53 147.32h320.29v16.6H-55.53z"
                                        transform="rotate(-60 104.617 155.617)"
                                    ></path>
                                    <path
                                        fill="#9F9FED"
                                        d="M14.06 268h320.3v16.6H14.06z"
                                    ></path>
                                    <path
                                        fill="#9F9FED"
                                        d="M96.35 223.89h16.6v185h-16.6z"
                                        transform="rotate(-60 104.65 316.382)"
                                    ></path>
                                    <path
                                        fill="#9F9FED"
                                        d="M235.53-17.19h16.6v185h-16.6z"
                                        transform="rotate(-60 243.82 75.31)"
                                    ></path>
                                    <path
                                        fill="#9F9FED"
                                        d="M12.2 66.95h185v16.6h-185z"
                                        transform="rotate(-30 104.696 75.253)"
                                    ></path>
                                    <path
                                        fill="#9F9FED"
                                        d="M235.64-4.52h16.6v320.29h-16.6z"
                                        transform="rotate(-30 243.94 155.624)"
                                    ></path>
                                    <path
                                        fill="#9F9FED"
                                        d="M26.76 103.3h16.6v185h-16.6zm278.4 0h16.6v185h-16.6z"
                                    ></path>
                                    <path
                                        fill="#9F9FED"
                                        d="M163.38 309.05h160.9v14.5h-160.9z"
                                        transform="rotate(-30 243.83 316.294)"
                                    ></path>
                                    <path
                                        fill="#9F9FED"
                                        d="M343.76 293.7c-9.6 16.7-31 22.4-47.7 12.8s-22.4-31-12.8-47.7c9.6-16.7 31-22.4 47.7-12.8 16.8 9.7 22.5 31 12.8 47.7M65.16 132.8c-9.6 16.7-31 22.4-47.7 12.8-16.7-9.6-22.4-31-12.8-47.7 9.6-16.7 31-22.4 47.7-12.8 16.7 9.7 22.4 31 12.8 47.7M4.76 293.7c-9.6-16.7-3.9-38 12.8-47.7 16.7-9.6 38-3.9 47.7 12.8 9.6 16.7 3.9 38-12.8 47.7-16.8 9.6-38.1 3.9-47.7-12.8m278.6-160.9c-9.6-16.7-3.9-38 12.8-47.7 16.7-9.6 38-3.9 47.7 12.8 9.6 16.7 3.9 38-12.8 47.7-16.7 9.6-38.1 3.9-47.7-12.8m-109.1 258.8c-19.3 0-34.9-15.6-34.9-34.9s15.6-34.9 34.9-34.9 34.9 15.6 34.9 34.9-15.6 34.9-34.9 34.9m0-321.8c-19.3 0-34.9-15.6-34.9-34.9S154.96 0 174.26 0s34.9 15.6 34.9 34.9-15.6 34.9-34.9 34.9"
                                    ></path>
                                </svg>
                                <span className="text-xs pt-1">GraphQL</span>
                            </div>
                        </div>
